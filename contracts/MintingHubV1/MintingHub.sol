...
import './interfaceV1/IPosition.sol';
import './interfaceV1/IPositionFactory.sol';
...
contract MintingHub {
	...
	function _finishChallenge(
		...
		(address owner, uint256 collateral, uint256 repayment, uint32 reservePPM) = _challenge.position.notifyChallengeSucceeded(
			msg.sender,
			size
		);
