...
describe("Position Tests", () => {
    ...
    describe("use Minting Hub", () => {
        it("create position", async () => {
            ...
            let tx = await mintingHubContract.openPosition(collateral, minCollateral, fInitialCollateral, initialLimit, duration, challengePeriod, fFees, fliqPrice, fReserve);
